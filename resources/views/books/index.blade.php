            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('books.create') }}" class="btn btn-sm btn-success"><i
                                class="ri-add-circle-line"></i> Add Book</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-danger btn-sm" title="Delete"
                                                onclick="confirmationDialog('delete-form-{{ $book->id }}', 'Are you sure?', 'This book will be permanently deleted!', 'Yes, delete it!')"><i
