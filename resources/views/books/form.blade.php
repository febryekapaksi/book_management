                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ isset($book) ? route('books.update', $book->id) : route('books.store') }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="publisher" name="publisher"
                                        value="{{ isset($book) ? $book->publisher : old('publisher') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input type="date" class="form-control" id="published_date" name="published_date"
                                        value="{{ isset($book) ? $book->published_date : old('published_date') }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input type="number" class="form-control" id="stock" name="stock"
                                        value="{{ isset($book) ? $book->stock : old('stock') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <button type="submit"
                                        class="btn btn-primary">{{ isset($book) ? 'Update Book' : 'Save Book' }}</button>
